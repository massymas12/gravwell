            ...
            html.Div(
                ...
                children=[
                    ...
                    html.Div([
                        ...
                        html.Div([
                            html.A("Windows (.exe)",
                                   href="/api/agent/download/binary?platform=windows",
                                   target="_blank", style=btn),
                            html.A("Linux",
                                   href="/api/agent/download/binary?platform=linux",
                                   target="_blank", style={**btn, "marginLeft": "6px"}),
                            html.A("macOS",
                                   href="/api/agent/download/binary?platform=macos",
                                   target="_blank", style={**btn, "marginLeft": "6px"}),
                        ...
                        html.Div(
                            "Binaries ship with the package and accept --server / --key at runtime.",
